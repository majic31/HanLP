 ...
 */
public class NaiveBayesClassifierNoChi extends AbstractClassifier
{
     ...
     */
    public NaiveBayesClassifierNoChi(NaiveBayesModel naiveBayesModel)
    {
     ...
     */
    public NaiveBayesClassifierNoChi()
    {
        this(null);
    }
