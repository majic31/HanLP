 ...
 */
public class ShortTermNaiveBayesClassifier extends AbstractClassifier
{
     ...
     */
    public ShortTermNaiveBayesClassifier(ShortTermNaiveBayesModel naiveBayesModel)
    {
     ...
     */
    public ShortTermNaiveBayesClassifier()
    {
        this(null);
    }
