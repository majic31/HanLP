...
import com.hankcs.hanlp.classification.models.ShortTermNaiveBayesModel;
 ...
 */
public class ShortTermNaiveBayesClassifierNoChi extends AbstractClassifier
{

    private ShortTermNaiveBayesModel model;
     ...
     */
    public ShortTermNaiveBayesClassifierNoChi(ShortTermNaiveBayesModel naiveBayesModel)
    {
     ...
     */
    public ShortTermNaiveBayesClassifierNoChi()
    {
        this(null);
    }
     ...
     * @return
     */
    public ShortTermNaiveBayesModel getNaiveBayesModel()
    {
        return model;
    }
    ...
    public void train(IDataSet dataSet)
    {
        ...
        //初始化分类器所用的数据
        model = new ShortTermNaiveBayesModel();
        ...
        model.featureCategoryJointCount = featureData.featureCategoryJointCount;
...
//                occurrences = model.featureCategoryJointCount[feature][category];

                logprob += model.logLikelihoods.get(feature).get(category); //将对数似然乘上频次
            }
    ...
    protected BaseFeatureData selectFeatures(IDataSet dataSet)
    {
        ...
        featureData.wordIdTrie = dataSet.getLexicon().wordId;
